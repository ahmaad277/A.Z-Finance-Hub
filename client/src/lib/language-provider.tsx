...
const translations = {
  en: {
    ...
    "report.expectedIRRColumn": "Expected IRR (%)",
  ...
  ar: {
    ...
    "metrics.expectedIRR": "العائد السنوية",
    ...
    "investments.irr": "العائد السنوية",
    "investments.expectedIrr": "العائد السنوية",
    ...
    "dialog.expectedIRR": "العائد السنوية (%)",
    ...
    "calculator.expectedIRR": "العائد السنوية (%)",
    ...
    "report.expectedIRRColumn": "العائد المتوقع (%)",
