...
const translations = {
  en: {
    ...
    // Bulk Import
    "bulkImport.title": "Bulk Import Investments",
    "bulkImport.subtitle": "Import multiple investments at once from Excel or CSV files",
    "bulkImport.dropzone": "Drop Excel or CSV file here, or click to browse",
    "bulkImport.supportedFormats": "Supported formats: .xlsx, .xls, .csv",
    "bulkImport.maxFileSize": "Maximum file size: 5MB",
    "bulkImport.fileSelected": "File selected",
    "bulkImport.processing": "Processing file...",
    "bulkImport.parseError": "Failed to parse file",
    "bulkImport.preview": "Preview & Edit",
    "bulkImport.validationErrors": "Validation Errors",
    "bulkImport.selectAll": "Select All",
    "bulkImport.deselectAll": "Deselect All",
    "bulkImport.selectedCount": "selected",
    "bulkImport.saveSelected": "Save Selected Investments",
    "bulkImport.saving": "Saving...",
    "bulkImport.successCount": "investments imported successfully",
    "bulkImport.required": "Required",
    "bulkImport.recommended": "Recommended",
    "bulkImport.optional": "Optional",
    "bulkImport.missingField": "Missing required field",
    "bulkImport.invalidValue": "Invalid value",
  ...
  ar: {
    ...
    // Bulk Import
    "bulkImport.title": "استيراد جماعي للفرص الاستثمارية",
    "bulkImport.subtitle": "استيراد عدة فرص استثمارية دفعة واحدة من ملفات Excel أو CSV",
    "bulkImport.dropzone": "أسقط ملف Excel أو CSV هنا، أو انقر للتصفح",
    "bulkImport.supportedFormats": "الصيغ المدعومة: .xlsx, .xls, .csv",
    "bulkImport.maxFileSize": "الحد الأقصى لحجم الملف: 5 ميجابايت",
    "bulkImport.fileSelected": "تم اختيار الملف",
    "bulkImport.processing": "جاري معالجة الملف...",
    "bulkImport.parseError": "فشل في قراءة الملف",
    "bulkImport.preview": "معاينة وتعديل",
    "bulkImport.validationErrors": "أخطاء التحقق",
    "bulkImport.selectAll": "اختيار الكل",
    "bulkImport.deselectAll": "إلغاء اختيار الكل",
    "bulkImport.selectedCount": "محدد",
    "bulkImport.saveSelected": "حفظ الفرص المحددة",
    "bulkImport.saving": "جاري الحفظ...",
    "bulkImport.successCount": "فرصة استثمارية تم استيرادها بنجاح",
    "bulkImport.required": "إلزامي",
    "bulkImport.recommended": "مستحسن",
    "bulkImport.optional": "اختياري",
    "bulkImport.missingField": "حقل إلزامي مفقود",
    "bulkImport.invalidValue": "قيمة غير صحيحة",
