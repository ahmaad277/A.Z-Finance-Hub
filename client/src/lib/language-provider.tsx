...
const translations = {
  en: {
    ...
    "dialog.totalExpectedReturn": "Total Expected Return",
    "dialog.expectedProfit": "Expected Profit",
    "dialog.numberOfUnits": "Number of Units/Shares",
  ...
  ar: {
    ...
    "dialog.totalExpectedReturn": "إجمالي العائد المتوقع",
    "dialog.expectedProfit": "الأرباح المتوقعة",
    "dialog.numberOfUnits": "عدد الوحدات/الأسهم",
