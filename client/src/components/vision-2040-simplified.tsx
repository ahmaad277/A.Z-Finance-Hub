      ...
      <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 p-3 sm:p-4 md:p-6">
        <div className="min-w-0 flex-1">
          <CardTitle className="flex items-center gap-2 text-base sm:text-lg">
            ...
            <span className="truncate">{t("vision2040.title")}</span>
          </CardTitle>
                ...
                <Card className="bg-blue-500/10 border-blue-500/20">
                  <CardContent className="p-2 sm:p-3">
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-xs font-medium truncate">{t("vision2040.currentPath")}</span>
                    </div>
                    <div className="text-sm sm:text-lg font-bold text-blue-500 truncate">
                ...
                <Card className="bg-green-500/10 border-green-500/20">
                  <CardContent className="p-2 sm:p-3">
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-xs font-medium truncate">{t("vision2040.targetPath")}</span>
                    </div>
                    <div className="text-sm sm:text-lg font-bold text-green-500 truncate">
                ...
                <Card className="bg-orange-500/10 border-orange-500/20">
                  <CardContent className="p-2 sm:p-3">
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-xs font-medium truncate">{t("vision2040.actualData")}</span>
                    </div>
                    <div className="text-sm sm:text-lg font-bold text-orange-500 truncate">
                      {formatCurrency(controller.currentPortfolioValue)}
                    </div>
                    <div className="text-xs text-muted-foreground truncate">
