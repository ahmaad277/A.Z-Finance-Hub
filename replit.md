...
- **Reports System:** Comprehensive financial reporting with Excel (XLSX) and PDF export, customizable date ranges, and platform filtering. **Independent Report Language Selection:** Separate language picker (English/Arabic) for report exports, independent of UI language setting. Excel exports fully support Arabic headers, labels, and RTL formatting; PDF exports use English only (jsPDF limitation).
